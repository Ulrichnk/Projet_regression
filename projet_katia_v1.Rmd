...
# Visualisation avec coloration par la variable "Claim"
library(factoextra)
train_1$Claim <- as.factor(train_1$Claim)  # Assurez-vous que Claim est un facteur
fviz_pca_ind(res_pca, habillage = "Claim", repel = TRUE, addEllipses = TRUE, 
             ellipse.level = 0.95, pointsize = 2)
